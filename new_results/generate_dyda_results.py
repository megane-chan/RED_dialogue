...
chat_preds_df = pd.DataFrame(unpacked_chat, columns=['DYDA_Chat_Preds'])
trans_preds_df = pd.DataFrame(unpacked_trans, columns=['DYDA_Trans_Preds'])


#save results to new csv
chat_preds_df.to_csv('new_results/DYDA_chat_preds.csv', index=False)
trans_preds_df.to_csv('new_results/DYDA_trans_preds.csv', index=False)